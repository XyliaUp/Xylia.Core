...
namespace Xylia.Windows.Framework
{
	...
	public class Win32API
	{
		...
		[DllImport("user32.dll", CharSet = CharSet.Auto)]
		static public extern bool GetMenuItemRect(IntPtr hWnd, IntPtr hMenu, uint Item, out RECT rc);
		...
		[DllImport("user32.dll", CharSet = CharSet.Auto)]
		public extern static int GetClientRect(IntPtr hWnd, out RECT rc);
		[DllImport("user32.dll", CharSet = CharSet.Auto)]
		...
		public static extern int ScreenToClient(IntPtr hWnd, out Rectangle rect);
