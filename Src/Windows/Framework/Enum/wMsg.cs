...
namespace Xylia.Windows.Framework.Enum
{
	public enum wMsg : int
	{
		...
		WM_SETCURSOR = 0x20,
		/// <summary>当光标在某个非激活的窗口中而用户正按着鼠标的某个键发送此消息给//当前窗口
		WM_MOUSEACTIVATE = 0x21,
		/// <summary>发送此消息给MDI子窗口//当用户点击此窗口的标题栏，或//当窗口被激活，移动，改变大小
		...
		WM_PAINTICON = 0x26,
		/// <summary>此消息发送给某个最小化窗口，仅//当它在画图标前它的背景必须被重画</summary> 
		...
		WM_TCARD = 0x52,
		/// <summary>此消息显示用户按下了F1，如果某个菜单是激活的，就发送此消息个此窗口关联的菜单，否则就发送给有焦点的窗口，如果//当前都没有焦点，就把此消息发送给//当前激活的窗口</summary> 
		WM_HELP = 0x53,
		...
		/// <summary>WM_KEYDOWN 按下一个键</summary>
		WM_KEYDOWN = 0x0100,
