namespace Xylia.Windows.Forms
{
    partial class PublicSet
    {
        ...
        private void InitializeComponent()
        {
			...
			this.EditorTabPage = new MetroFramework.Controls.MetroTabPage();
			this.SaveSettingsButton = new MetroFramework.Controls.MetroButton();
			this.HighlightsColorPanel = new System.Windows.Forms.Panel();
			this.ResetSettingsButton = new MetroFramework.Controls.MetroButton();
			...
			this.EditorTabPage.HorizontalScrollbarBarColor = true;
			...
			this.EditorTabPage.VerticalScrollbarBarColor = true;
			// 
			// SaveSettingsButton
			// 
		...
		private MetroFramework.Controls.MetroTabPage EditorTabPage;
		private MetroFramework.Controls.MetroButton SaveSettingsButton;
		private System.Windows.Forms.Panel HighlightsColorPanel;
		private MetroFramework.Controls.MetroButton ResetSettingsButton;
