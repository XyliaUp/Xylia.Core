        ...
        private void tvMenu_AfterSelect(object sender, TreeViewEventArgs e)
        {
            ...
            switch (strName)
            {
                ...
                case "多输入窗体":
                    ...
                    break;
                case "气泡提示窗体":
                    FrmTips.ShowTipsError("Error提示信息");
                    FrmTips.ShowTipsInfo( "Info提示信息");
                    FrmTips.ShowTipsSuccess( "Success提示信息");
                    FrmTips.ShowTipsWarning( "Warning提示信息");
                    FrmTips.ShowTips("自定义提示信息", 2000, true, ContentAlignment.MiddleCenter, null, TipsSizeMode.Medium, new Size(300, 50), TipsState.Success);
                    break;
                case "有返回的窗体":
                ...
                case "等待窗体":
                    ControlHelper.ThreadRunExt(this, () =>
                    {
                        ...
                        {
                            FrmTips.ShowTipsSuccess("FrmWaiting测试");
                        });
                    }, null, this);
                    break;
                case "仅有标题的窗体":
