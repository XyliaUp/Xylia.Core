...
namespace HZH_Controls.Controls
{
    ...
    partial class UCLEDTime
    {
        ...
        private void InitializeComponent()
        {
			...
			this.D1.TabIndex = 0;
			this.D1.Value = '2';
			this.D1.ValueChar = HZH_Controls.Controls.LEDNumChar.CHAR_2;
			// 
			// D2
			// 
			...
			this.D2.TabIndex = 1;
			this.D2.Value = '3';
			this.D2.ValueChar = HZH_Controls.Controls.LEDNumChar.CHAR_3;
			// 
			// D3
			// 
			...
			this.D3.TabIndex = 2;
			this.D3.Value = ':';
			this.D3.ValueChar = HZH_Controls.Controls.LEDNumChar.CHAR_Colon;
			// 
			// D4
			// 
			...
			this.D4.TabIndex = 3;
			this.D4.Value = '1';
			this.D4.ValueChar = HZH_Controls.Controls.LEDNumChar.CHAR_1;
			// 
			// D5
			// 
			...
			this.D5.TabIndex = 4;
			this.D5.Value = '0';
			this.D5.ValueChar = HZH_Controls.Controls.LEDNumChar.CHAR_0;
			// 
			// D6
			// 
			...
			this.D6.TabIndex = 5;
			this.D6.Value = ':';
			this.D6.ValueChar = HZH_Controls.Controls.LEDNumChar.CHAR_Colon;
			// 
			// D7
			// 
			...
			this.D7.TabIndex = 6;
			this.D7.Value = '1';
			this.D7.ValueChar = HZH_Controls.Controls.LEDNumChar.CHAR_1;
			// 
			// D8
			// 
			...
			this.D8.TabIndex = 7;
			this.D8.Value = '0';
			this.D8.ValueChar = HZH_Controls.Controls.LEDNumChar.CHAR_0;
			// 
			// UCLEDTime
			// 
