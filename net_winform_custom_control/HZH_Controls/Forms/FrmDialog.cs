...
namespace HZH_Controls.Forms
{
        ...
        public partial class FrmDialog : FrmBase
        {
                ...
                #region 显示一个模式信息框
                public static DialogResult ShowDialog(string strMessage, string strTitle = null, bool blnShowCancel = false, bool isShowMaskDialog = true, bool blnShowClose = false, bool blnIsEnterClose = true, Size? deviationSize = null)
                {
                        return ShowDialog(null, strMessage, strTitle, blnShowCancel, isShowMaskDialog, blnShowClose, blnIsEnterClose, deviationSize);
                }
            ...
            Size? deviationSize = null)
                {
                        if (strTitle == null) strTitle = "提示信息";
                ...
                {
                        if (blnEnterClose)  this.DialogResult = DialogResult.OK;
                }
